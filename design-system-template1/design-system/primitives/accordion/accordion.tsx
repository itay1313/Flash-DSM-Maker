...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn('ds-border-b ds-border-border', className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ref={ref}
    className="ds-overflow-hidden ds-text-sm data-[state=closed]:ds-animate-accordion-up data-[state=open]:ds-animate-accordion-down"
    {...props}
  >
